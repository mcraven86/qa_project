...
class dataCleaner():
    ...
    def save_to_sql(self,df, table_name, engine, if_exists='replace'):
            """
...
#customers = load_and_clean_csv('../Data/03_Library SystemCustomers.csv', primary_key='customer_id')
    def main(self):
        books = self.load_and_clean_csv('C:/Users/Admin/Desktop/qa_project/Data/03_Library_Systembook.csv', primary_key='id')
        customers = self.load_and_clean_csv('C:/Users/Admin/Desktop/qa_project/Data/03_Library SystemCustomers.csv', primary_key='customer_id')
        ...
        self.save_to_sql(books_with_customers, 'books_with_customers', engine)
        self.save_to_sql(books_per_customer, 'books_per_customer', engine)
        #save to csv 
